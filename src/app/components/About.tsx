    ...
    <div className="min-h-screen bg-[#050208] text-white flex flex-col relative overflow-hidden font-sans">
      ...
      <header className="relative z-30 flex items-center justify-between px-8 py-6 border-b border-white/5 bg-black/20 backdrop-blur-3xl sticky top-0">
        <div className="flex items-center gap-4 group cursor-default">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[9px] font-black uppercase tracking-[0.3em] text-purple-400/60">Neural Network</span>
          </div>
        </div>
      ...
      <main className="relative z-10 flex-1 overflow-y-auto custom-scrollbar">
        ...
        <section className="max-w-7xl mx-auto px-8 pt-16 pb-12">
          <div className="bg-white/[0.02] border border-white/5 backdrop-blur-3xl rounded-[3.5rem] p-8 md:p-16 flex flex-col md:flex-row items-center gap-12 shadow-3xl">
            ...
            <div className="flex-1 text-left">
              ...
              <div className="mt-10 flex gap-4">
                 <div className="px-6 py-3 rounded-2xl bg-white/5 border border-white/10 flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest text-white/60">Status: Operacional</span>
                 </div>
              </div>
            </div>
            ...
            <div className="relative group flex-shrink-0">
              ...
              <div className="relative p-12 rounded-[3rem] bg-black/40 border border-white/10 backdrop-blur-2xl shadow-2xl transition-transform duration-500 group-hover:scale-105 group-hover:rotate-2">
        ...
        <section className="px-8 py-12 max-w-7xl mx-auto">
           <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div key={idx} className="p-8 rounded-[2.5rem] bg-white/[0.02] border border-white/5 hover:border-purple-500/20 transition-all group shadow-xl">
        ...
        <section className="px-8 py-12 max-w-7xl mx-auto">
          <div className="p-10 rounded-[3.5rem] bg-gradient-to-br from-purple-900/10 to-transparent border border-white/5">
            <h2 className="text-3xl font-black text-white mb-10 flex items-center gap-4">
              <Users className="text-purple-500" /> Core Team
            </h2>
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div key={i} className="flex items-center gap-4 p-4 rounded-3xl bg-black/40 border border-white/5 hover:border-purple-500/30 transition-all group">
                  <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-2xl group-hover:scale-110 transition-all">
                    {member.emoji}
                  </div>
                  <div>
                    <h4 className="text-white font-black text-sm">{member.name}</h4>
        ...
        <section className="px-8 pb-20 pt-12">
          <div className="max-w-7xl mx-auto flex flex-wrap justify-center gap-8 text-center border-t border-white/5 pt-16">
            {[
          ...
          <p className="text-center text-[9px] font-black uppercase tracking-[0.5em] text-white/10 mt-16">
